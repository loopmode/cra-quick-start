...
* [Changes from vanilla CRA](#changes)
...
* Support SASS, stage-0 and decorators via [custom-react-scripts](https://github.com/kitze/custom-react-scripts)
* Support HMR via [index.js modification](https://medium.com/superhighfives/hot-reloading-create-react-app-73297a00dcad)
* Added [prettier](https://github.com/prettier/prettier), [prettier-eslint](https://github.com/prettier/prettier-eslint) and configuration
* Added sublime project file to auto-format using prettier upon file save
